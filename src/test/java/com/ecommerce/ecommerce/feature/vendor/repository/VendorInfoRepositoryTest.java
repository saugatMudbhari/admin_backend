...
public class VendorInfoRepositoryTest {
   ...
   @Test
    void itShouldOnboardVendor(){
       ...
       vendorTest.setAccountHolder("Saugat Mudbhari");
       vendorTest.setVendorEmail("smudbhari85@gmail.com");
       ...
       vendorTest.setVendorUserName("saugat___");
       ...
       vendorTest.setBankName("Global");

       VendorUserRequestDto vendorUserTest = new VendorUserRequestDto();

       vendorUserTest.setFirstName("saugat");
       vendorUserTest.setLastName("mudbhari");
       vendorUserTest.setWardNo("04");
       vendorUserTest.setContactNumber("98734545");
